...
$query = "SELECT * FROM pemaincewe WHERE posisi = 'Attacker'";
...
foreach ($positions as $position) {
    ...
    $query = "SELECT * FROM pemaincewe WHERE posisi = '$position'";
    $result = mysqli_query($conn, $query);
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "
            ...
            <a href='biopemaincw.php?id_pemaincw={$row['id_pemaincw']}' class='card-link'> <!-- Tambahkan link -->
                <div class='card'>
