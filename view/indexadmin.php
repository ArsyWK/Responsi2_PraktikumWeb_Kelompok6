...
<body>
  ...
  <!-- Form Tambah Berita -->
  <div class="form-tambah-container" id="formTambahContainer">
    <form class="form-tambah-berita">
  ...
  <script>
    // Event listener for form visibility
    document.querySelector('.btn-plus').addEventListener('click', function() {
      document.getElementById('formTambahContainer').style.display = 'block';
    });
    document.getElementById('btnClose').addEventListener('click', function() {
      document.getElementById('formTambahContainer').style.display = 'none';
    });
  </script>
